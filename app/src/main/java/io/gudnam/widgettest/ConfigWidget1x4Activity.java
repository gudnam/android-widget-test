 ...
 */
public class ConfigWidget1x4Activity extends AppCompatActivity implements WidgetConfigAdapter.OnItemClickListener {
    private static final String TAG = ConfigWidget1x4Activity.class.getSimpleName();
